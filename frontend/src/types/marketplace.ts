...
export type ChatMessage = { _id: string; conversationId: string; senderId: string; message: string; messageType?: "text" | "voice"; audioDataUrl?: string; audioMimeType?: string; audioDurationSeconds?: number; createdAt: string; readAt?: string };
