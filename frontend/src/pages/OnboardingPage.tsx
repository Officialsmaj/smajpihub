        ...
        <section className="home-section onboarding-form-section" id="onboarding-form">
          <form className="contact-form onboarding-form" onSubmit={handleSubmit}>
            ...
            <label htmlFor="onboarding-name">
              <span>Full Name</span>
              <input id="onboarding-name" type="text" placeholder="Your full name" required />
            </label>
            <label htmlFor="onboarding-email">
              <span>Email</span>
              <input id="onboarding-email" type="email" placeholder="info@example.com" required />
            </label>
            <label htmlFor="onboarding-track">
              <span>Application Type</span>
              <select id="onboarding-track" defaultValue="" required>
            ...
            <label htmlFor="onboarding-location">
              ...
              <input id="onboarding-location" type="text" placeholder="City, country, or target market" required />
            </label>
            ...
            {submitted ? (
              <p className="contact-form-success">
                Application noted. For direct follow-up, email info@smajpihub.com with your details.
              </p>
            ) : null}
          </form>
