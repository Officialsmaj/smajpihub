...
const discoveryTabs = [["For you", "/dashboard"], ["Trending", "/trending"], ["Lifestyle", "/lifestyle"], ["Categories", "/categories"]] as const;
...
const MobileHome = () => {
  ...
  return <div className="mobile-super-home">
    ...
    <footer className="mobile-private-footer"><strong>SMAJ PI HUB</strong><p>Connecting everyday services in one platform.</p><nav><Link to="/about">About</Link><Link to="/app/services">Services</Link><Link to="/help">Help Center</Link><Link to="/privacy">Privacy Policy</Link><Link to="/terms">Terms</Link><Link to="/contact">Contact</Link></nav><div className="mobile-socials"><span>Follow us</span><a href="https://www.linkedin.com/company/smajecosystem" aria-label="LinkedIn" target="_blank" rel="noreferrer"><LinkedInIcon /></a><a href="https://instagram.com/smajecosystem" aria-label="Instagram" target="_blank" rel="noreferrer"><InstagramIcon /></a><a href="https://x.com/smajecosystem" aria-label="X" target="_blank" rel="noreferrer"><XIcon /></a><a href="https://youtube.com/@smajecosystem" aria-label="YouTube" target="_blank" rel="noreferrer"><YouTubeIcon /></a><a href="https://t.me/smajecosystem" aria-label="Telegram" target="_blank" rel="noreferrer"><TelegramIcon /></a></div><small>Part of the SMAJ Ecosystem</small><small>(c) 2026 SMAJ PI HUB. All rights reserved.</small></footer>
  </div>;
};
