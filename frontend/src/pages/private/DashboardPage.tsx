...
const DesktopFeedHome = ({ activeTab, onTabChange }: { activeTab: DiscoveryTab; onTabChange: (tab: DiscoveryTab) => void }) => <div className="desktop-private-home desktop-feed-home">
  ...
  <footer className="private-home-footer"><div><strong>SMAJ PI HUB</strong><p>Connecting everyday services in one platform.</p><div className="private-home-socials" aria-label="Social links"><a href="https://x.com/smajpihub" aria-label="X" target="_blank" rel="noreferrer"><XIcon fontSize="small" /></a><a href="https://t.me/smajpihub" aria-label="Telegram" target="_blank" rel="noreferrer"><TelegramIcon fontSize="small" /></a><a href="https://instagram.com/smajpihub" aria-label="Instagram" target="_blank" rel="noreferrer"><InstagramIcon fontSize="small" /></a><a href="https://youtube.com/@smajpihub" aria-label="YouTube" target="_blank" rel="noreferrer"><YouTubeIcon fontSize="small" /></a><a href="https://www.tiktok.com/@smajpihub" aria-label="TikTok" target="_blank" rel="noreferrer"><MusicNoteOutlinedIcon fontSize="small" /></a></div></div><nav><Link to="/about">About</Link><Link to="/app/services">Services</Link><Link to="/help">Help Center</Link><Link to="/privacy">Privacy Policy</Link><Link to="/terms">Terms of Service</Link><Link to="/cookies">Cookie Policy</Link><Link to="/report-abuse">Report Abuse</Link><Link to="/seller-agreement">Seller Agreement</Link><Link to="/contact">Contact</Link></nav><div><span>Part of the SMAJ Ecosystem</span><span>(c) 2026 SMAJ PI HUB. All rights reserved.</span></div></footer>
</div>;
