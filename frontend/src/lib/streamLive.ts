...
export const getPublishedLiveInputs = async () => (await axiosClient.get<{ live: Array<Pick<CreatorLiveInput, "liveInputUid" | "title" | "processingStatus" | "chatMode"> & { creatorName?: string; thumbnailUrl?: string | null }> }>("/stream/live-content")).data.live;
