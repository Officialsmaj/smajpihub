...
export type StreamProfile = { displayName: string; avatarUrl: string; country: string; language: string; subtitleLanguage: string; favoriteGenres: string[]; preferredRegions: string[]; maturityLevel: "kids" | "13" | "16" | "18"; videoQuality: "auto" | "data-saver" | "hd" | "full-hd"; autoplay: boolean; dataSaver: boolean; showActivity: boolean; emailNotifications: boolean };
