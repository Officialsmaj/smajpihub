...
const configuredAdminNavigation: AdminNavGroup[] = [
  ...
  { number: 11, label: "SMAJ Pi Edu", icon: "platform", items: items(["Dashboard", "Courses", "Students", "Instructors", "Universities", "Partner Verification", "Enrollments", "Learning Paths", "Certificates", "Payments", "Reviews", "Reports"], { "Partner Verification": "/admin/education/teachers" }) },
